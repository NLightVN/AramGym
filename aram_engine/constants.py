...
TURRET_DATA = {
    ...
    "blue_shrine":  {"pos": (648.1,   764.2),   "team": "blue", "type": "shrine",
                     "hp": 9999, "armor": 100, "mr": 100,
                     "attack_range": 1250, "base_dmg": 999, "invuln": True},
    "blue_inhib_t": {"pos": (5448.4,  6169.1),  "team": "blue", "type": "inhibitor",
                     "hp": 1300, "armor": 60, "mr": 100,
                     "attack_range": 750,  "base_dmg": 152, "invuln": False},
    "blue_front_1": {"pos": (3809.1,  3829.1),  "team": "blue", "type": "outer",
                     "hp": 1300, "armor": 60, "mr": 100,
                     "attack_range": 750,  "base_dmg": 152, "invuln": False},
    "blue_front_2": {"pos": (4943.5,  4929.8),  "team": "blue", "type": "outer",
                     "hp": 1300, "armor": 60, "mr": 100,
                     "attack_range": 750,  "base_dmg": 152, "invuln": False},
    ...
    "red_shrine":   {"pos": (12168.7, 11913.3), "team": "red",  "type": "shrine",
                     "hp": 9999, "armor": 100, "mr": 100,
                     "attack_range": 1250, "base_dmg": 999, "invuln": True},
    "red_inhib_t":  {"pos": (8548.8,  8289.5),  "team": "red",  "type": "inhibitor",
                     "hp": 1300, "armor": 60, "mr": 100,
                     "attack_range": 750,  "base_dmg": 152, "invuln": False},
    "red_front_1":  {"pos": (7879.1,  7774.8),  "team": "red",  "type": "outer",
                     "hp": 1300, "armor": 60, "mr": 100,
                     "attack_range": 750,  "base_dmg": 152, "invuln": False},
    "red_front_2":  {"pos": (9017.6,  8871.4),  "team": "red",  "type": "outer",
                     "hp": 1300, "armor": 60, "mr": 100,
                     "attack_range": 750,  "base_dmg": 152, "invuln": False},
...
INHIBITOR_DATA = {
    "blue_inhib": {"pos": (5448.4, 6169.1), "team": "blue",
                   "hp": 4000, "max_hp": 4000, "armor": 20, "mr": 0,
                   "radius": 150, "regen": 15, "respawn_time": 300},
    "red_inhib":  {"pos": (8548.8, 8289.5), "team": "red",
                   "hp": 4000, "max_hp": 4000, "armor": 20, "mr": 0,
                   "radius": 150, "regen": 15, "respawn_time": 300},
}
...
# ─────────────────────────────────────────────────
YASUO_STATS = {
    "base_hp":       517.76, "hp_growth":       82.0,
    "base_hp_regen":   6.512, "hp_regen_growth":  0.9,
    "base_mp":        60.0,  "mp_growth":        0.0,
    "base_ad":        55.376, "ad_growth":        3.2,
    "base_armor":     24.712, "armor_growth":     3.4,
    "base_mr":        30.0,  "mr_growth":        0.0,
    "base_ms":       340.0,
    "base_as":         0.670, "as_ratio":         0.032,  # +3.2% per level
    "attack_range":  175.0,
...
MINION_STATS = {
    "melee": {
        "base_hp": 455, "hp_growth_per_min": 22,
    ...
    "caster": {
        "base_hp": 290, "hp_growth_per_min": 15,
        "base_ad": 23,  "ad_growth_per_min": 1.5,
        "base_ms": 325, "armor": 0, "mr": 0,
        "attack_range": 550, "attack_speed": 0.625,
        "gameplay_radius": MINION_GAMEPLAY_RADIUS_NORMAL,
        "pathfinding_radius": MINION_PATHFINDING_RADIUS,
        "gold": 17, "gold_growth_rate": 0.125, "gold_growth_interval": 90,
        "xp": 29,
    },
    "cannon": {
        "base_hp": 700, "hp_growth_per_min": 35,
        "base_ad": 40,  "ad_growth_per_min": 3,
        "base_ms": 325, "armor": 15, "mr": 0,
        "attack_range": 300, "attack_speed": 0.625,
        "gameplay_radius": MINION_GAMEPLAY_RADIUS_CANNON,
        "pathfinding_radius": MINION_PATHFINDING_RADIUS,
        "gold": 60, "gold_max": 90, "gold_per_wave": 3,
        "xp": 90,
    },
    "super": {
        "base_hp": 1500, "hp_growth_per_180s": 150, "hp_scale_stop_min": 90,
        "base_ad": 215,  "ad_growth_per_90s": 5,    "ad_scale_stop_min": 90,
        "base_ms": 325, "armor": 30, "mr": -30,
        "attack_range": 170, "attack_speed": 0.625,
        "gameplay_radius": MINION_GAMEPLAY_RADIUS_CANNON,
        "pathfinding_radius": MINION_PATHFINDING_RADIUS,
        "gold": 40,  # fixed, no scaling
        "xp": 95,
    },
}
